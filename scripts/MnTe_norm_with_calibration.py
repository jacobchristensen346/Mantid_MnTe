...
## large region at 445 K
start = 180423 # update this according to temperature
stop =  start + 120
#temp = 'MnTe_06K_Total'  # use if LoadCC=0; update name according to temperature
temp = 'MnTe_06K_CC' # use if LoadCC=1; update name according to temperature
UBfile=scriptdir+'MnTe_06K.mat' # update according to temperature
...
for idx, r in enumerate(runs):
    ...
    if filethere:
        ...
        LoadParameterFile(workspace=dataR,
                          Filename="/SNS/CORELLI/IPTS-23019/shared/Natrolite_2021B/calibration_germanium_cubic_trans_beam.xml")
